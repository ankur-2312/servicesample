...
public class SerialImageDownloadActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void onReceiveBroadcast() {
        ...
        IntentFilter filter = new IntentFilter(getString(R.string.broadcastactionserial));
    ...
    public void onClick(View v) {
        for (int i = 0; i <= 2; i++) {
            Intent intent = new Intent(SerialImageDownloadActivity.this, SerialImageDownloadService.class);
